...
| Hub labels | `HUB_LABELS`, `HUB_TASK_LABELS` | Hub-defined task labels (manual or LLM-seeded auto) and their per-task applications — distinct from the client-synced `RESOLVED_SESSION_LABELS` |
